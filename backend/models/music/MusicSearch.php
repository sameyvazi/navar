...
class MusicSearch extends Music
{
    ...
    public function rules()
    {
        ...
        return [
            [['status', 'status_fa', 'status_app', 'status_site', 'status_zizz', 'type', 'artist_id', 'genre_id'], 'integer'],
            [['id', 'created_at', 'name', 'name_fa', 'key', 'key_fa'], 'safe'],
        ];
    }
...
//        ]);
        ...
        $query->andFilterWhere(['id' => $this->id])
            ...
            ->andFilterWhere(['like', 'key_fa', $this->key_fa])
            ...
            ->andFilterWhere(['status_zizz' => $this->status_zizz != null ? (int)$this->status_zizz : null]);
