...
<div class="row">
    <div class="col-md-11">
        <div class="row">
            ...
            <?php if (Yii::$app->getUser()->can('AdminUserAdd')): ?>
            <div class="col-md-2">
                <a class="btn btn-primary fancybox fancybox.ajax" href="<?= Url::to(['/admin/add']); ?>"><i class="fa fa-admin-plus"></i> <?= Yii::t('app', 'Add new admin'); ?></a>
            </div>
            <?php endif; ?>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return $data->getStatusButton($data->status, Url::to(['/admin/status', 'id' => $data->id]), 'AdminUserDisable', 'adminList-pjax', 'message_container');
                        }
                    ],
                    [
                        'class' => \yii\grid\ActionColumn::class,
                        'template' => '{update}',
                        'visible' => Yii::$app->getUser()->can('AdminUserUpdate'),
                        'buttons' => [
