...
$this->title = Yii::t('app', 'Artists Manager');
    ...
    <div class="col-md-11">
        <div class="row">
            ...
            <?php if (Yii::$app->getUser()->can('ArtistAdd')): ?>
                <div class="col-md-2">
                    <a class="btn btn-primary fancybox fancybox.ajax" href="<?= Url::to(['/artist/add']); ?>"><i class="fa fa-admin-plus"></i> <?= Yii::t('app', 'Add new artist'); ?></a>
                </div>
            <?php endif; ?>
<!---->
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return $data->getStatusButton($data->status, Url::to(['/artist/status', 'id' => $data->id]), 'ArtistDisable', 'artistList-pjax', 'message_container');
                        }
                    ],
                    [
                        'attribute' => 'status_fa',
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return $data->getStatusButton($data->status_fa, Url::to(['/artist/status-fa', 'id' => $data->id]), 'ArtistDisable', 'artistList-pjax', 'message_container');
                        }
                    ],
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return $data->getStatusButton($data->status_app, Url::to(['/artist/status-app', 'id' => $data->id]), 'ArtistDisable', 'artistList-pjax', 'message_container');
                        }
                    ],
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return $data->getStatusButton($data->status_site, Url::to(['/artist/status-site', 'id' => $data->id]), 'ArtistDisable', 'artistList-pjax', 'message_container');
                        }
                    ],
                    [
                        'class' => \yii\grid\ActionColumn::class,
                        'template' => '{update}',
                        'visible' => Yii::$app->getUser()->can('ArtistUpdate'),
                        'buttons' => [
