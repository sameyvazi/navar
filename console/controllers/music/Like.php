...
class Like extends Action {
    ...
    public function run() {
        ...
        Yii::$app->language = 'en';
        $this->controller->stdout("Transfer of Like started...\n", Console::FG_YELLOW);
        ...
        foreach ($likes as $like){
            ...
            if ($meta){
                ...
                $model = Likes::find()->where(['type' => Music::TYPE_INAVAR ,'post_id' => isset($music->id) ? $music->id : 0, 'author_ip' => $like['ip']])->one();
        ...
        $this->controller->stdout("The transfer of the Likes is over.\n", Console::FG_GREEN);
